...
Array.prototype.slice.call(arguments,1));else if(a instanceof Object||!a)return x.init.apply(this,arguments);else d.error("Method "+a+" does not exist on jQuery.ht5ifv plugin")};var h={},k={extend:function(a,c,b){w.push({definitions:a,global:c,selfContained:b})},register:function(a,c,b){a&&(h[a]===void 0||b)?h[a]=c:console.warn("Cannot registry the handler with name: %s",a)},unregister:function(a){delete h[a]},clean:function(){h={}},registerType:function(a,c,b){k.register(a,function(){return{types:function(b){b[a]=
{restrictions:{type:c}};return b}({})}},b)},registerRestriction:function(a,c,b){k.register(a,function(){return{restrictions:function(b){b[a]=c;return b}({})}},b)},use:function(a){if(a)for(var c=0;c<arguments.length;c++){var b=arguments[c];if(typeof b=="string")h[b]?d.ht5ifv("extend",h[b].apply(this)):console.warn("Cannot find the handler with name: %s",b);else if(b instanceof Array){var f=b.shift();f&&h[f]?d.ht5ifv("extend",h[f].apply(this,b)):console.warn("Cannot find the handler with name: %s",
b)}}else d.each(h,function(a,b){d.ht5ifv("extend",b.apply(this))})}};d.ht5ifv=function(a){if(k[a])return k[a].apply(this,Array.prototype.slice.call(arguments,1));else d.error("Static Method "+a+" does not exist on jQuery.ht5ifv plugin")}})(jQuery);